...
public class AdapterChatMsg extends RecyclerView.Adapter<AdapterChatMsg.ViewHolder> {

//    Typeface tf;
    int current_page, last_page;
    private ArrayList<ModelChatMsg> arrayList;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;
    private Activity activity;
//    RelativeLayout container;
    public AdapterChatMsg(Activity activity, ArrayList<ModelChatMsg> r) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.chatting_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final ModelChatMsg item = arrayList.get(position);
//        try {
